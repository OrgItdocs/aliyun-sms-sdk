...
class SmsServer
{
     ...
     * @param $smsValue  短信替换内容 ['code'=>'1234','open'=>'aad']
     * @return mixed|\SimpleXMLElement
     */
    public function sendSms($mobile, $templateCode, $smsValue, $outId = '', $smsUpExtendCode = '') {
        ...
        $request->setTemplateParam(json_encode($smsValue, JSON_UNESCAPED_UNICODE));
...
//    }
     ...
     * @return stdClass
     */
    public function querySendDetails($mobile, $date, $bizId = '') {
